...
if __name__ == '__main__':
    ...
    parser.add_argument('--src', type=str, help='Path to src image', default='./img/img1.jpg')
    parser.add_argument('--dst', type=str, help='Path to dst image', default='./img/img2.jpg')
    parser.add_argument('--frames', type=int, help='# of frames for animation', default=12)
    ...
    # read images
    src_origin = cv2.imread("D:\ASSIGNMENT-II MSc DS\IVA\205229102_IVA_PROJECT\img\img1.jpg")
    src_img = src_origin.copy()
    dst_origin = cv2.imread("D:\ASSIGNMENT-II MSc DS\IVA\205229102_IVA_PROJECT\img\img2.jpg")
